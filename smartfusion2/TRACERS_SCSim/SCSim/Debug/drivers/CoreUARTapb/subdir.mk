...
drivers/CoreUARTapb/%.o: ../drivers/CoreUARTapb/%.c
	...
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -O1 -fsigned-char -ffunction-sections -fdata-sections  -g3 -DLWIP_COMPAT_MUTEX   -DLWIP_PROVIDE_ERRNO -DMICROSEMI_STDIO_THRU_MMUART0 -I".." -I"../CMSIS" -I"../CMSIS/startup_gcc" -I"../hal/" -I"../hal/CortexM3" -I"../hal/CortexM3/GNU"   -I"../drivers/CoreUARTapb" -I"../drivers_config" -I"../drivers_config/sys_config"  -std=gnu11 --specs=nano.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
